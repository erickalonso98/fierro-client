...
@Component({
  selector: 'app-id-report-form',
  templateUrl: './id-report-form.component.html',
  styleUrls: ['./id-report-form.component.css']
})
export class IdReportFormComponent implements OnInit {
  ...
  constructor(private _personService:PersonService) { 
    this.page_title = 'Reporte x Identificador'
    this.url = global.url;
    this.persona = new Person(0,1,'','','','','',1,'','','','',1,'','','');
  }
